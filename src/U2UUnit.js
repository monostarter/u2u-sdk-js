...
export default class U2UUnit {
    ...
    static fromString(unit) {
        switch (unit) {
            ...
            case U2UUnit.MiliU2U._symbol:
                return U2UUnit.MiliU2U;
...
U2UUnit.TinyU2U = new U2UUnit("tinyu2u", "tℏ", new BigNumber(1));

U2UUnit.MicroU2U = new U2UUnit("microu2u", "μℏ", new BigNumber(100));

U2UUnit.MiliU2U = new U2UUnit("miliu2u", "mℏ", new BigNumber(100000));

U2UUnit.U2U = new U2UUnit("u2u", "ℏ", new BigNumber("100000000"));
